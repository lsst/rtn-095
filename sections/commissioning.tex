...
\centering
\plotone{visitDates}
\caption{Temporal distribution of DP1 observations, grouped by field as a function of MJD and color-coded by filter. Each point indicates that a given field was observed at least once in the corresponding filter on that date.}
