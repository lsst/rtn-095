...
To avoid deblender failures from excessive increases in object density, stars with a total \gls{magnitude} brighter than 17.5~${\rm mag}$  (i.e., derived from flux summed across all six bands) are excluded, as are galaxies whose \gls{magnitude} is brighter than 15\,${\rm mag}$ or fainter than 26.5\,${\rm mag}$.
...
The correction for Kron fluxes can be derived from the S\'ersic index \citep[][]{2005PASA...22..118G}, but this correction is not provided in \textt{Object} tables.
...
This was also seen in the \gls{DES} \citep[][]{2025arXiv250105739B}, who dubbed such objects ``super-spreaders''.
