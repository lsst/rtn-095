...
\begin{figure}[htb!]
\centering
\includegraphics[scale=0.29]{dT_T_Piff_poly_order_2}
\includegraphics[scale=0.29]{dT_T_Piff_poly_order_4}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.98\linewidth]{dT_T_Piff_poly_4_vs_mag}
...
\figref{fig:dmAstroErr} shows the median per-\gls{tract} astrometric error for all isolated point sources, both after the initial calibration and after the final calibration, which includes proper motion corrections.
...
In the main survey, the longer time baseline and greater distortions near the \gls{LSSTCam} field edges will make global calibration more impactful.
 \begin{figure}[htb!]
 \centering
 \includegraphics[width=0.98\linewidth]{Astrometry_dmAstroErr}
...
\figref{fig:AM1} shows the median separation for pairs of objects separated by approximately 5 arcminutes, computed per tract after the final calibration.
 \begin{figure}[htb!]
 \centering
 \includegraphics[width=0.9\linewidth]{Astrometry_AM1}
...
\begin{figure*}[htb!]
\centering
\includegraphics[width=0.98\linewidth]{Astrometry_2024120200359}
...
\begin{figure*}[htb!]
\centering
\includegraphics[width=0.98\linewidth]{Astrometry_2024120700527}
\caption{\small Astrometric residuals in $u$ (left panel) and $v$ (center panel) directions, with the E and B-modes of the two-point correlation function (right panel). 
...
\begin{figure*}[htb!]
\centering
\includegraphics[width=1.0\linewidth]{Astrometry_CCD}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.98\linewidth]{injected_lsst_cells_v1_5063_i_completeness_any}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.98\linewidth]{dcrHexbin}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.98\linewidth]{efficiency_snr_griz}
...
\begin{figure}[htb!]
\centering
\includegraphics[trim={0 0 0 0},width=\linewidth]{coordinate_offsets_hexbin}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.98\linewidth]{sso_residuals}
