...
\ref{fig:injected_lsst_cells_v1_5063_galaxy_sersic_chi} shows that Sersic model fluxes and colors have similar behavior to as CModel, but with a greater degree of overestimation.
