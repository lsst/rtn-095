...
Based on estimates of the scatter in the error-scaled residuals in matched injected objects, flux uncertainties are underestimated by a factor of at least 2 (for PSF model fluxes for stars) to 3 (for galaxy model fluxes).
...
For example, centroids and color uncertainties overestimates are consistent over a broad magnitude range, whereas flux uncertainty overestimates increase with signal-to-noise.
