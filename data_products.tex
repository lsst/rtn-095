...
{\bf To facilitate processing, Rubin \gls{DP1} uses a single skymap\footnote{A skymap is a tiling of the celestial sphere, organizing large-scale sky coverage into manageable sections for processing and analysis.} that covers the entire sky area encompassing the seven \gls{DP1} fields.
...
The aerial coverage of a patch is comparable to, but somewhat smaller than, the \rawfov field-of-view of a single LSSTComCam or LSSTCam detector, meaning each detector image covers multiple patches.}
