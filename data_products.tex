...
In the case of \texttt{template\_coadd}s, the third of \texttt{visit\_image}s covering the \gls{patch} in question with the narrowest \gls{PSF} \gls{FWHM} are selected.
