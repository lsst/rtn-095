 \graphicspath{{./}{figures/data_products}}
% Lead: James Mullaney
...
Full details on how the \texttt{Calibration} catalog was built are provided in \cite{DMTN-277}\footnote{In \citep{DMTN-277},  the calibration reference catalog is referred to as ``The Monster". This terminology is also carried over to the DP1 Butler.}. 
