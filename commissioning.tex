...
\end{figure}
The LSSTCam and \gls{LSSTComCam} focal planes are described in detail in \citet{ctn001}.
...
\caption{Cumulative distribution of PSF FWHM (arcsec) over all \nvisitdetectorsummaries visits images in the DP1 dataset for each filter. The vertical dashed lines represent the median PSF FWHM at 1.46, 1.36, 1.24, 1.18 and 1.20 arcsec for the $ugrizy$ wavebands, respectively}
