...
EUTELSAT 117 West B is part the \gls{GPS} system and serves as one of \gls{WAAS} satellites operated for the  \gls{FAA} and used to broadcast \gls{GPS} corrections to air traffic.
