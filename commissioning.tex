...
Under favorable \gls{seeing} conditions, the delivered image quality was typically around {0.7\arcsec\xspace}, with a best recorded value of \bestimagequality.

%%%%% ComCam
\subsection{The LSST Commissioning Camera
\label{ssec:comcam}}
The \gls{LSSTComCam} \citep{2022SPIE12184E..0JS,2020SPIE11447E..0LS,2018SPIE10700E..3DH, 10.71929/rubin/2561361} is a 144-megapixel, scaled-down version of the 3.2-gigapixel \gls{LSSTCam}.
It covers approximately 5\% of the \gls{LSSTCam} focal plane area, with a  field of view of 0.7deg$^2$   (40\arcmin 	x40\arcmin), compared to LSSTCam's 9.6 deg$^2$. 
...
The sensors selected for \gls{LSSTComCam} represent the lowest-performing units from the LSSTCam production batch and exhibit known issues, such as high readout noise (e.g., Detector 8) and elevated \gls{CTI} (e.g., Detector 5).
...
All DP1 images are 30 second exposures for all bands.
