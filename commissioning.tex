...
% be measured with signal-to-noise  = 5 in the r-band.
% \begin{figure*}[ht]
%     \centering
%     \begin{subfigure}[t]{0.3\textwidth}
%         \centering
%         \includegraphics[width=\linewidth]{./DP1_47_Tuc_psf_maglim_r.pdf}
%         \caption{47 Tucanae}
%     \end{subfigure}\hfill
%     \begin{subfigure}[t]{0.3\textwidth}
%         \centering
%         \includegraphics[width=\linewidth]{./DP1_Fornax_dSph_psf_maglim_r.pdf}
%         \caption{Fornax dwarf Spheroidal}
%     \end{subfigure}\hfill
%     \begin{subfigure}[t]{0.3\textwidth}
%         \centering
%         \includegraphics[width= \linewidth]{./DP1_ECDFS_psf_maglim_r.pdf}
%         \caption{ECDFS}
%     \end{subfigure}
%     \vspace{1em}
...
%     \begin{subfigure}[t]{0.3\textwidth}
%         \centering
%         \includegraphics[width=\linewidth]{./DP1_EDFS_comcam_psf_maglim_r.pdf}
%         \caption{EDFS}
%     \end{subfigure}\hfill
%     \begin{subfigure}[t]{0.3\textwidth}
%         \centering
%         \includegraphics[width=\linewidth]{./DP1_Rubin_SV_095_-25_psf_maglim_r.pdf}
%         \caption{RubinSV\_95\_-25}
%     \end{subfigure}\hfill
%     \begin{subfigure}[t]{0.3\textwidth}
%         \centering
%         \includegraphics[width=\linewidth]{./DP1_Seagull_psf_maglim_r.pdf}
%         \caption{Seagull}
%     \end{subfigure}
%     \vspace{1em}
...
%         \centering
%         \includegraphics[width=\linewidth]{./DP1_Rubin_SV_38_7_psf_maglim_r.pdf}
%         \caption{Rubin\_SV\_38\_7}
%     \end{subfigure}
%     \hspace*{0.3\textwidth}
%     \caption{Cumulative imaging depth expressed in terms of the SNR= 5 limiting r-band magnitude for unresolved sources in the seven DP1 fields.}
...
The DP1 median delivered image quality, quantified as the \gls{PSF} \gls{FWHM} across all bands, is \medianimagequalityallbands, with the best images achieving approximately \bestimagequality.
\figref{fig:delivered_image_quality_ecdf} shows the cumulative distribution of PSF FWHM (arcsec) over all \nvisitdetectorsummaries individual sensors images, with separate curves for each filter.
Vertical dashed lines indicate the median PSF FWHM values:  1.46, 1.36, 1.24, 1.18 and 1.20 arcsec for the $ugrizy$ bands respectively.
\begin{figure}[htb]
\centering
\includegraphics[width=\linewidth]{image_quality_ecdf}
\caption{Cumulative distribution of PSF FWHM (arcsec) over all \nvisitdetectorsummaries individual sensors in the DP1 dataset for each filter.
The vertical dashed lines represent the median PSF FWHM at 1.46, 1.36, 1.24, 1.18 and 1.20 arcsec for the $ugrizy$ bands  respectively.}
