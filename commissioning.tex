...
During  commissioning of the \gls{LSST Science Pipelines}(\secref{ssec:pipelines_commissioning}), observations were undertaken using the open-loop component with no correction for thermal effects.
