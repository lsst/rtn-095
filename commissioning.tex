...
It varies both by passband and   target field. 
The per-band median PSF FWHM  values are: u = \umedianimagequality,  g = \gmedianimagequality, r = \rmedianimagequality, i = \imedianimagequality, z = \zmedianimagequality, y = \ymedianimagequality arcsecs.
...
\begin{figure*}[hbt!]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    ...
    \caption{Per band across all fields. } 
 \end{subfigure}\hfill
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\linewidth]{image_quality_histo_per_field}
    \caption{Per field for all bands}
  \end{subfigure}\hfill
\caption{Histograms showing the  distribution of PSF FHWM for all \nvisitdetectorsummaries single-epoch individual sensors in the DP1 dataset. The median values are given in the legend. }
