...
It currently supports a large subset of ADQL, with limitations documented in the data release materials (see \secref{ssec:documentation}) and exposed via the TAP \textbf{capabilities} endpoint where possible. \gregory{Get reference for \gls{CADC} TAP}
...
\caption{The Rubin \gls{Science Platform} Portal Aspect, showing a DP1 image> \gregory{Replace with a real DP1 image}}
