\section{Rubin Science Platform (RSP)}
\label{sec:data_services}

The Rubin Science Platform \citep[RSP;][]{LSE-319} is a powerful, cloud-based environment for scientific research and analysis of petascale-scale astronomical survey data.
...
The  Consolidated Database \citep[ConsDB;][]{DMTN-227} is an SQL-compatible database designed to store and manage metadata for Rubin Observatory science and calibration images.
