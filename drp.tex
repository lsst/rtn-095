...
The discovery component of Solar system processing uses the \texttt{heliolinx} package\footnote{\nolinkurl{https://github.com/heliolinx/heliolinx}} of asteroid identification and linking tools \citep{heliolinx}.
...
The inputs to the processing comprised all sources detected in difference images produced by an early processing of the \gls{LSSTComCam} commissioning data, some of which were later rejected during \gls{DP1} processing and, as a result, are not part of \gls{DP1}.
