...
This bug has since been fixed and is not expected to impact the galaxy fluxes significantly, since the higher-order shapelet PSF parameters tend to be small.
