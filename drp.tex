...
The association component begins by generating expected positions for all objects in the \gls{MPC} orbit catalog, using ephemerides computed with the \texttt{Sorcha} survey simulation toolkit \citep[][]{Merritt_2025} \footnote{Available at \nolinkurl{https://github.com/dirac-institute/sorcha}}.
