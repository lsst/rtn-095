...
The third and final Data Preview, \gls{DP2}, is planned to be based on a reprocessing of all science-grade data taken with Rubin's \gls{LSSTCam} during commissioning and is expected to be released around mid-2026.
