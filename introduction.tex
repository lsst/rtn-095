...
The first, \gls{DP0}\footnote{See \url{https://dp0.lsst.io}}, contained data products produced from the processing of simulated \gls{LSST}-like data sets.
...
\gls{DP0} was released in multiple phases; DP0.1, DP0.2, and DP0.3,  each building upon the previous one and incorporating new data and functionalities.
DP0.1 and DP0.2 used data from the cosmoDC2 simulations \citep[][]{2021ApJS..253...31L} prepared by the Dark Energy Science Collaboration (DESC), whereas DP0.3 is based on simulated datasets from the Solar System Science Collaboration (SSSC).
