...
\caption{DP1 median 5$\sigma$ coadded point-source detection limits per field and band, compared with the expected 10-year  LSST values derived from the baseline simulated survey \citep{2022ApJS..258....1B}. } 
