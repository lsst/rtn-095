...
\caption{Number of \texttt{raw} images per field and band.
Each raw image corresponds to a single 30-second LSSTComCam exposure on one CCD. Most exposures produce nine raw images, one per sensor in the focal plane, however some yield fewer due to occasional hardware or readout issues.}
