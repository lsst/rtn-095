...
\tablehead{
  ...
  \colhead{\textbf{Format or Valid Values}} &
...
\texttt{exposure} & YYYYMMDD\#\#\#\#\# & \parbox[t]{10cm}{A single exposure of all nine LSSTComCam detectors.} \\
\texttt{instrument} & LSSTComCam & \parbox[t]{10cm}{The instrument name.} \\
\texttt{detector} & 0--8 & \parbox[t]{10cm}{A LSSTComCam detector.} \\
