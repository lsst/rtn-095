...
\caption{The name and number of each type of data product in the Butler and the dimensions required to identify a specific dataset.}
...
\startdata
\multicolumn{4}{l}{\textbf{Image Data Products}} \\
...
%
\multicolumn{4}{l}{\textbf{Catalog Data Products}} \\
