...
\caption{DP1 fields and pointing centers with the number of exposures in each band per field. \gls{ICRS} coordinates are in units of decimal degrees, and are specified as J2000.}
