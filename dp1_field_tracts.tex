...
\caption{Tract coverage of each DP1 field. The size of a tract is larger than the LSSTComCam field of view; however, since each observed field extends across more than one tract, each field covers multiple tracts.}
